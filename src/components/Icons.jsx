...
export function UserIcon() {
  ...
  export const LogoIconP = ({ size = 60, className = '', ...props }) => {
    return (
      <svg
        width={size}
        height={size}
      ...
      >
        <g id="layer1">
          <path
            id="path58"
            fill="#fff"
            strokeWidth="0.0185995"
            d="M 13.306302,4.3892074 11.735436,5.3181602 V 8.9738419 L 13.325078,8.0338125 Z"
          />
          <path
            id="path49"
            fill="#fff"
            strokeWidth="0.0204137"
            d="M 8.0880878,1.214881 2.7790493,4.3543954 5.0019518,5.6547817 10.300338,2.5215968 Z"
          />
          <path
            id="path52"
            fill="#fff"
            strokeWidth="0.0204137"
            d="m 8.789075,3.6504548 -3.7613835,2.2487494 -0.0077,0.00475 v 1.6057824 0.2625667 4.0272207 0.548341 2.312256 l 3.10755,-1.845985 -2.3849367,-1.408832 -0.4990789,0.272272 V 7.6376941 L 8.78908,5.5034023 Z M 7.7034685,3.9386559 c -0.00959,0.0053 -0.9031363,0.5713637 -2.683477,1.6989307 v 0.00654 l 0.0039,-0.00231 1.062e-4,-1.056e-4 h 1.041e-4 c 1.407e-4,-8.71e-5 4.095e-4,-2.243e-4 6.142e-4,-3.217e-4 l 1.041e-4,-1.056e-4 C 6.802214,4.5120063 7.6960456,3.9442038 7.7035495,3.93866 Z m -2.9070116,7.9980031 -2.2465354,1.377922 0.9884513,0.596234 1.2580841,0.743079 z"
          />
          <path
            id="path50"
            fill="#fff"
            strokeWidth="0.0204137"
            d="M 2.5499215,4.4811957 V 13.326923 L 4.7964569,14.654 V 5.8081655 Z"
          />
          <path
            id="path79"
            fill="#fff"
            strokeWidth="0.0204137"
            d="M 10.574299,2.6392191 8.9279007,3.6127946 11.596188,5.2024371 13.218533,4.2011172 Z"
          />
          <path
            id="path54"
            fill="#fff"
            strokeWidth="0.0204137"
            d="M 8.9678192,3.9207226 V 5.5276401 L 11.511954,7.1705289 V 5.4411882 Z"
          />
          <path
            id="path73"
            fill="#fff"
            strokeWidth="0.0204137"
            d="M 6.2262798,7.2997012 V 9.1065493 L 8.7442424,10.595553 V 8.7881779 Z"
          />
          <path
            id="path80"
            fill="#fff"
            strokeWidth="0.0204137"
            d="M 11.511902,7.2997012 8.9677768,8.8036851 V 10.610955 L 11.511902,9.1065493 Z"
          />
          <path
            id="path81"
            fill="#fff"
            strokeWidth="0.0204137"
            d="M 8.7442836,5.8012032 6.4378912,7.1560196 7.8784041,8.0309676 8.7442836,7.5713515 Z M 6.4477154,7.4233858 6.5483745,9.0348375 7.6863053,8.1757594 Z"
          />
        </g>
      </svg>
    );
