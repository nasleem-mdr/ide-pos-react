// RequisitionView.jsx , ini adalah modul khusus untuk menampilkan status document dengan
...
export default function RequisitionView() {
  ...
  async function fetchDoc() {
    ...
    setError(null);
    try {
      const res = await fetch(`${BACKEND_URL}/public/requisition/${uuid}`);
      ...
      <div style={s.card}>
        ...
        <div style={s.header}>
          ...
          <div style={s.headerText}>
            <p style={s.eyebrow}>Formulir Permintaan Barang</p>
